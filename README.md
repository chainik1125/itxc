...
define a yaml config file (or use the provided `temporal_xc/scripts/train_mnist/mnist.yaml`) and run

```bash
python temporal_xc/scripts/train_mnist/run_train_mnist.py <path_to_config_file>
```
